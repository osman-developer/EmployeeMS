...
namespace EmployeeMS.Infrastructure.Migrations
{
    ...
    [Migration("20250301123702_contractsConfiguring")]
    partial class contractsConfiguring
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EmployeeMS.Domain.Entities.ContractStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3636),
                            StatusName = "Active"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3640),
                            StatusName = "Terminated"
                        },
                        new
                        {
                            Id = 3,
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3642),
                            StatusName = "On Leave"
                        });
                });
            ...
            modelBuilder.Entity("EmployeeMS.Domain.Entities.EmployeeContractType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3666)
                        },
                        new
                        {
                            Id = 2,
                            ContractTypeName = "Part-time",
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3669)
                        },
                        new
                        {
                            Id = 3,
                            ContractTypeName = "Temporary ",
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3671)
                        },
                        new
                        {
                            Id = 4,
                            ContractTypeName = "Contract",
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3673)
                        },
                        new
                        {
                            Id = 5,
                            ContractTypeName = "Internship",
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3675)
                        },
                        new
                        {
                            Id = 6,
                            ContractTypeName = "Freelance / Consultant",
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3677)
                        });
                });
            ...
            modelBuilder.Entity("EmployeeMS.Domain.Entities.EmployeeFileType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3412),
                            TypeName = "profile_picture"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3471),
                            TypeName = "id_picture"
                        },
                        new
                        {
                            Id = 3,
                            CreationDate = new DateTime(2025, 3, 1, 14, 37, 1, 695, DateTimeKind.Local).AddTicks(3474),
                            TypeName = "attachment"
                        });
                });
